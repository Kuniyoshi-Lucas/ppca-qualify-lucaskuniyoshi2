...
\midrule
6 & \citeonline{wang_distribution_2022} - Research paper & Distribution prediction of strategic flight delays via machine learning methods & Machine learning-based model (Single airport) & \acrlong{CAN} (3 years) & Prediction accuracy exceeding 80\% was achieved. \\
\midrule
