...
\begin{xltabular}{\textwidth}{p{0.5cm} p{4cm} p{10cm}}
	\caption[Glossary of relevant terms in WASG's slot management]{Glossary
	of relevant terms in WASG's slot management. Adapted
	from~\cite{WASG2020}.} \label{tab:def} \\
...
1 & Slots & A permission given by a coordinator for a planned operation to use an airport's infrastructure at a specific date and time. \\ 
...
13 & Annual movements & All movements that have specific times in both Summer and Winter seasons. \\
14 & Messages & The data shared between coordinator, facilitator and air operators \cite{SSIM2020}. The messages are usually in a standard format recognized by the industry (e.g., SSIM), containing critical information about the slot, i.e., operations' start date, operations' end date, air operator IATA's code, equipment type (e.g., Boeing 737 MAX), number of seats offered, type of movement air (e.g., Passenger or Cargo), frequency of operation during the week, hours of operation (slots), among others.\\ \hline
\end{xltabular}
